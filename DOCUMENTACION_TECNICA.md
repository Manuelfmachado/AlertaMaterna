...
1. **Predicción concentrada en la media:**
   ...
   - **Restricciones aplicadas (con fundamentación científica):**
     ...
     3. **Cap de coherencia clínica:** Si MN<5‰ y MF<15‰ → MI máximo 3x MN (o 8‰)
        - Fundamentación: La mortalidad neonatal representa el 60-70% de la infantil en Colombia. Un factor de 3x es un límite superior conservador (asume MN=33%).
        - Referencia: DANE Estadísticas Vitales / WHO Global Health Estimates
